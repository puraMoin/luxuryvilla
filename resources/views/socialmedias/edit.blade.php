        ...
        <div class="card-style mt-20">
                    ...
                    <div class="select-style-1">
                        ...
                        <div class="select-position select-sm">
                            <select id="company_website_id" name="company_website_id" class="jSelectbox" required>>
                                <option value="{{ $companywebsite->id }}" selected>{{ $companywebsite->name }}
                                </option>
            ...
            <div class="row mt-15">
                <div class="col-sm-3">
                    ...
                    <div id="imageBox">
                        <img id="selectedImage" src="{{ $socialmedias->image ? asset('images/socialmedias/image/' . $socialmedias->id . '/' . $socialmedias->image) : asset('images/no-image.png') }}"
                            alt="Selected Image">
                    </div>
