       ...
       <div class="row mt-15">
        <!-- Image -->
         <div class="col-sm-6">
           <label>Image</label>
            <div id="iconBox">
           <img id="selectedIcon" src="{{ $socialmedias->image ? asset('images/socialmedias/image/' . $socialmedias->id . '/' . $socialmedias->image) :
           asset('images/no-image.png') }}" alt="Selected Image">
           </div>
