                ...
                <div class="table-wrapper table-responsive mt-10">
                    <table class="table striped-table">
                        <thead>
                            <tr>
                                <th width="25">
                                    <div class="check-input-primary"><input class="form-check-input" type="checkbox"
                                            id="checkbox-1"></div>
                                </th>
                                <th>
                                    <h6><a href="#">Country <i class="lni lni-sort-alpha-asc"></i></a></h6>
                                </th>
                                <th>
                                    <h6><a href="#"> Alpha 2 Code <i class="lni lni-sort-alpha-asc"></i></a></h6>
                                </th>
                                <th>
                                    <h6><a href="#">Alpha 3 Code<i class="lni lni-sort-alpha-asc"></i></a></h6>
                                </th>
                                <th>
                                    <h6>Calling Code</h6>
                                </th>
                        ...
                        <tbody>
                            ...
                            @foreach ($countries as $country)
                                <tr>
                                            ...
                                            @if (!empty($country->image_file))
                                                @php
                                                    ...
                                                    $imagePath = $firstImage
                                                        ? asset("images/country/image_file/{$id}/{$firstImage}")
                                                        : null;
                                    ...
                                    <td class="text-center"><a href="{{ route('countries.edit', $country->id) }}"><i
                                                class="lni lni-pencil-alt"></i></a>
                                        <a href="{{ route('countries.show', $country->id) }}"><i
