                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="active" class="radio-inline" value="1" {{ old('active', $department->active) == 1 ? 'checked' : '' }}> Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="active" class="radio-inline" value="0" {{ old('active', $department->active) == 0 ? 'checked' : '' }}> No
                            </label>
                        </div>                        
                    </div>
                    <hr>
