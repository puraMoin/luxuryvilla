    ...
    <section class="section">
        ...
        <div class="container-fluid">
            <div class="card-style mt-20">
                ...
                <form action="{{ route('suppliercontacts.update', $suppliercontact->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="input-style-1">
                                ...
                                <input type="text" id="name" name="name"
                                    class="form-control" value="{{ $suppliercontact->name }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-style-1">
                                ...
                                <input type="text" id="mobile" name="mobile"
                                    class="form-control numeric" value="{{ $suppliercontact->mobile }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="active" class="radio-inline" value="1" {{ $suppliercontact->active == 1 ? 'checked' : '' }}>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="active" class="radio-inline" value="0" {{ $suppliercontact->active == 0 ? 'checked' : '' }}>
                                No
                            </label>
                        </div>
