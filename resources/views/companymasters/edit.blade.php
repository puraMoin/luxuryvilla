                    ...
                    <div class="row mt-15">
                        ...
                        <div class="col-sm-3">
                            <div class="input-style-1">
                                ...
                                <input type="text" name="registration_no" placeholder="Enter Regsitration No"
                                    value="{{ $companymaster->registration_no }}" />
                            </div>
                        </div>
                        <!-- Vat No  -->
                        <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="business_registration_name"
                                        ...
                                        value="{{ $companymaster->business_registration_name }}" />
                                </div>
                            </div>
                            <!-- Tin No  -->
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="incorporate_name" placeholder="Enter Incorporate Name"
                                        value="{{ $companymaster->incorporate_name }}" />
                                </div>
                            </div>
                        ...
                        <div class="row mt-15">
                            ...
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="phone_calling_code_1"
                                        placeholder="Enter Phone Calling Code 1"
                                        value="{{ $companymaster->phone_calling_code_1 }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="contact_no_1" placeholder="Enter Contact No 1"
                                        value="{{ $companymaster->contact_no_1 }}" />
                                </div>
                            </div>
                        ...
                        <div class="row mt-15">
                            ...
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="phone_calling_code_2"
                                        placeholder="Enter Phone Calling Code 2"
                                        value="{{ $companymaster->phone_calling_code_2 }}" />
                                </div>
                            </div>
                            <!--Contact no 2  -->
                            <div class="col-sm-3">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="contact_no_2" placeholder="Enter Contact no 2"
                                        value="{{ $companymaster->contact_no_2 }}" />
                                </div>
                            </div>
                            <!-- Email  -->
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-5">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="facebook_link" placeholder="Enter Facebook Link"
                                        value="{{ $companymaster->facebook_link }}" />
                                </div>
                            </div>
                            <!-- Twitter Link  -->
                            <div class="col-sm-5">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="twitter_link" placeholder="Enter Twitter Link"
                                        value="{{ $companymaster->twitter_link }}" />
                                </div>
                            </div>
                            <!-- Active Code -->
                            <div class="col-sm-2">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="active" class="radio-inline" value="1"
                                        {{ $companymaster->active == 1 ? 'checked' : '' }}> Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="active" class="radio-inline" value="0"
                                        {{ $companymaster->active == 0 ? 'checked' : '' }}> No
                                </label>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row mt-15">
                            ...
                            <div class="col-sm-4">
                                @php
                                    $filepath = asset(
                                        'images/companymasters/image_file/' .
                                            $companymaster->id .
                                            '/' .
                                            $companymaster->image_file,
                                    );
                                    $headerfilepath = asset(
                                        'images/companymasters/header_image_file/' .
                                            $companymaster->id .
                                            '/' .
                                            $companymaster->header_image_file,
                                    );
                                    $footerfilepath = asset(
                                        'images/companymasters/footer_image_file/' .
                                            $companymaster->id .
                                            '/' .
                                            $companymaster->footer_image_file,
                                    );
                                @endphp
                            ...
                            <div class="col-sm-4">
                                ...
                                <div id="HeaderBox">
                                    <img id="selectedHeaderImage"
                                        src="{{ $companymaster->header_image_file ? $headerfilepath : asset('images/no-image.png') }}"
                                        alt="Selected Image">
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div id="FooterBox">
                                    <img id="selectedFooterImage"
                                        src="{{ $companymaster->footer_image_file ? $footerfilepath : asset('images/no-image.png') }}"
                                        alt="Selected Image">
                                </div>
